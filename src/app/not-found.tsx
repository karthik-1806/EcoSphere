...
export default function NotFound() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[rgb(var(--bg))] px-4 py-10">
      <div className="w-full max-w-2xl rounded-[32px] border border-white/[0.08] bg-slate-950/95 p-10 text-center shadow-2xl shadow-black/20">
        ...
        <p className="mt-4 text-sm leading-7 text-slate-400">
          The page you are looking for does not exist or may have been moved. Use the links below to
          get back on track.
        </p>
